...
//            $postId = $metadata[key($metadata)]['content_id'];
		...
		WiziappLog::getInstance()->write('DEBUG', "The Cincopa album is " . print_r($json->items, TRUE),
...
function wiziapp_cincopaJson($albumId){
	...
	WiziappLog::getInstance()->write('DEBUG', "About to request a cincopa album with the url: {$url}", "cincopa_plugin.wiziapp_cincopaJson");
	$r = new WiziappHTTPRequest();
