...
class WiziappVideoGalleryCellItem extends WiziappLayoutComponent{
    ...
    */
    ...
    public $htmlTemplate = '<li class="videoGalleryCellItem default __ATTR_class__ cellItem">
                                <span class="attribute text_attribute imageURL __ATTR_classOf-thumbnailURL__" data-image-src="__ATTR_thumbnailURL__">
                                    <img class="hidden" src="" data-class="__ATTR_classOf-thumbnailURL__"/>
                                </span>
                                <span class="title attribute text_attribute">__ATTR_title__</span>
                                <span class="description attribute text_attribute">_ATTR_description__</span>
                            </li>';
    ...
    */
    function get_actionURL_attr(){
        ...
        return WiziappLinks::convertVideoActionToWebVideo($this->data[0]['actionURL']);
    }
